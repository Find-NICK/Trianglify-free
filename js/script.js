...
/*============ EXPORT - png ============*/
$('.preview__export-png-btn').click(function (e) {
    e.preventDefault();
    saveCanvasToPng(patternPreview);
    // downloadPng(pattern.png());
    $('.preview__export-png-btn .tooltip').toggleClass('show');
    setTimeout(function () {
        $('.preview__export-png-btn .tooltip').toggleClass('show');
    }, 1000);
});
...
$('.preview__export-svg-btn').click(function (e) {
    e.preventDefault();
    const svgData = getSvgData(pattern.toSVG());
    downloadSvg(svgData);
    $('.preview__export-svg-btn .tooltip').toggleClass('show');
    setTimeout(function () {
        $('.preview__export-svg-btn .tooltip').toggleClass('show');
    }, 1000);
});

function downloadSvg(base64string) {
    let fileName = "trianglify";
    const link = document.createElement('a');
